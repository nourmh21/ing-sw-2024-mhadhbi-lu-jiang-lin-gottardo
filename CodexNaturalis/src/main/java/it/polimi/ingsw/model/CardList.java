...
public final class CardList{
    ...
    public CardList(){
        ...
        // RESOURCE CARDS
        cardList.add(new Card(1, Symbol.FUNGI,Symbol.FUNGI, Symbol.FUNGI, Symbol.EMPTY, Symbol.HIDDEN, 0, CardType.RESOURCE));
        cardList.add(new Card(2, Symbol.FUNGI,Symbol.FUNGI, Symbol.EMPTY, Symbol.HIDDEN, Symbol.FUNGI, 0, CardType.RESOURCE));
        ...
        cardList.add(new Card(5, Symbol.FUNGI,Symbol.EMPTY, Symbol.FUNGI, Symbol.HIDDEN, Symbol.EMPTY, 1, CardType.RESOURCE));
        cardList.add(new Card(6, Symbol.FUNGI,Symbol.HIDDEN, Symbol.EMPTY, Symbol.EMPTY, Symbol.FUNGI, 1, CardType.RESOURCE));
        cardList.add(new Card(7, Symbol.FUNGI,Symbol.FUNGI, Symbol.HIDDEN, Symbol.EMPTY, Symbol.EMPTY, 1, CardType.RESOURCE));
        cardList.add(new Card(8, Symbol.FUNGI,Symbol.FUNGI, Symbol.INSECT, Symbol.HIDDEN, Symbol.PARCHMENT, 0, CardType.RESOURCE));
        cardList.add(new Card(9, Symbol.FUNGI,Symbol.INK_BOTTLE, Symbol.FUNGI, Symbol.ANIMAL, Symbol.HIDDEN, 0, CardType.RESOURCE));
        cardList.add(new Card(10, Symbol.FUNGI,Symbol.HIDDEN, Symbol.FEATHER, Symbol.FUNGI, Symbol.PLANT, 0, CardType.RESOURCE));

        cardList.add(new Card(11, Symbol.PLANT, Symbol.PLANT, Symbol.PLANT,  Symbol.EMPTY, Symbol.HIDDEN, 0, CardType.RESOURCE));
        cardList.add(new Card(12, Symbol.PLANT, Symbol.PLANT, Symbol.EMPTY,  Symbol.HIDDEN, Symbol.PLANT, 0, CardType.RESOURCE));
        ...
        cardList.add(new Card(15, Symbol.PLANT, Symbol.EMPTY, Symbol.EMPTY, Symbol.PLANT, Symbol.HIDDEN, 1, CardType.RESOURCE));
        cardList.add(new Card(16, Symbol.PLANT, Symbol.EMPTY, Symbol.EMPTY, Symbol.HIDDEN, Symbol.PLANT, 1, CardType.RESOURCE));
        cardList.add(new Card(17, Symbol.PLANT, Symbol.HIDDEN, Symbol.PLANT, Symbol.EMPTY, Symbol.EMPTY, 1, CardType.RESOURCE));
        cardList.add(new Card(18, Symbol.PLANT, Symbol.FUNGI, Symbol.PLANT, Symbol.INK_BOTTLE, Symbol.HIDDEN, 0, CardType.RESOURCE));
        cardList.add(new Card(19, Symbol.PLANT, Symbol.PARCHMENT, Symbol.HIDDEN, Symbol.ANIMAL, Symbol.PLANT, 0, CardType.RESOURCE));
        cardList.add(new Card(20, Symbol.PLANT, Symbol.HIDDEN, Symbol.INSECT, Symbol.PLANT, Symbol.FEATHER, 0, CardType.RESOURCE));

        cardList.add(new Card(21, Symbol.ANIMAL, Symbol.ANIMAL, Symbol.ANIMAL,  Symbol.HIDDEN, Symbol.EMPTY, 0, CardType.RESOURCE));
        cardList.add(new Card(22, Symbol.ANIMAL, Symbol.EMPTY, Symbol.ANIMAL, Symbol.ANIMAL, Symbol.HIDDEN, 0, CardType.RESOURCE));
        cardList.add(new Card(23, Symbol.ANIMAL, Symbol.ANIMAL, Symbol.HIDDEN, Symbol.EMPTY, Symbol.ANIMAL, 0, CardType.RESOURCE));
        cardList.add(new Card(24, Symbol.ANIMAL, Symbol.HIDDEN, Symbol.EMPTY, Symbol.ANIMAL, Symbol.ANIMAL, 0, CardType.RESOURCE));
        cardList.add(new Card(25, Symbol.ANIMAL, Symbol.EMPTY, Symbol.ANIMAL, Symbol.HIDDEN, Symbol.EMPTY, 1, CardType.RESOURCE));
        cardList.add(new Card(26, Symbol.ANIMAL, Symbol.EMPTY, Symbol.HIDDEN, Symbol.ANIMAL, Symbol.EMPTY, 1,  CardType.RESOURCE));
        cardList.add(new Card(27, Symbol.ANIMAL, Symbol.HIDDEN, Symbol.EMPTY, Symbol.EMPTY, Symbol.ANIMAL, 1, CardType.RESOURCE));
        cardList.add(new Card(28, Symbol.ANIMAL, Symbol.PLANT, Symbol.ANIMAL, Symbol.PARCHMENT, Symbol.HIDDEN, 0, CardType.RESOURCE));
        cardList.add(new Card(29, Symbol.ANIMAL, Symbol.FEATHER, Symbol.HIDDEN, Symbol.FUNGI, Symbol.ANIMAL, 0, CardType.RESOURCE));
        cardList.add(new Card(30, Symbol.ANIMAL, Symbol.HIDDEN, Symbol.INSECT, Symbol.ANIMAL, Symbol.INK_BOTTLE, 0, CardType.RESOURCE));

        cardList.add(new Card(31, Symbol.INSECT, Symbol.INSECT, Symbol.INSECT, Symbol.HIDDEN, Symbol.EMPTY, 0, CardType.RESOURCE));
        cardList.add(new Card(32, Symbol.INSECT, Symbol.EMPTY, Symbol.INSECT, Symbol.INSECT, Symbol.HIDDEN, 0, CardType.RESOURCE));
        cardList.add(new Card(33, Symbol.INSECT, Symbol.INSECT, Symbol.HIDDEN, Symbol.EMPTY, Symbol.INSECT, 0, CardType.RESOURCE));
        cardList.add(new Card(34, Symbol.INSECT, Symbol.HIDDEN, Symbol.EMPTY, Symbol.INSECT, Symbol.INSECT, 0, CardType.RESOURCE));
        cardList.add(new Card(35, Symbol.INSECT, Symbol.EMPTY, Symbol.EMPTY, Symbol.INSECT, Symbol.HIDDEN, 1, CardType.RESOURCE));
        cardList.add(new Card(36, Symbol.INSECT, Symbol.INSECT, Symbol.HIDDEN, Symbol.EMPTY, Symbol.EMPTY, 1,  CardType.RESOURCE));
        cardList.add(new Card(37, Symbol.INSECT, Symbol.HIDDEN, Symbol.INSECT, Symbol.EMPTY, Symbol.EMPTY, 1, CardType.RESOURCE));
        cardList.add(new Card(38, Symbol.INSECT, Symbol.INSECT, Symbol.PLANT, Symbol.HIDDEN, Symbol.INK_BOTTLE, 0, CardType.RESOURCE));
        cardList.add(new Card(39, Symbol.INSECT, Symbol.PARCHMENT, Symbol.INSECT, Symbol.FUNGI, Symbol.HIDDEN, 0, CardType.RESOURCE));
        cardList.add(new Card(40, Symbol.INSECT, Symbol.HIDDEN, Symbol.FEATHER, Symbol.INSECT, Symbol.ANIMAL, 0, CardType.RESOURCE));
        ...
        cardList.add(new GoldCard(48, Symbol.FUNGI, Symbol.FEATHER, Symbol.EMPTY, Symbol.HIDDEN, Symbol.HIDDEN, 3, CardType.GOLD,
                Symbol.EMPTY, 3,0,0,0));
        cardList.add(new GoldCard(49, Symbol.FUNGI, Symbol.EMPTY, Symbol.PARCHMENT, Symbol.EMPTY, Symbol.HIDDEN, 3, CardType.GOLD,
        ...
        cardList.add(new GoldCard(63, Symbol.ANIMAL, Symbol.EMPTY, Symbol.HIDDEN, Symbol.EMPTY, Symbol.FEATHER, 2, CardType.GOLD,
        ...
        cardList.add(new GoldCard(78, Symbol.INSECT, Symbol.EMPTY, Symbol.PARCHMENT, Symbol.HIDDEN, Symbol.HIDDEN, 3, CardType.GOLD,
                Symbol.EMPTY, 0,0,0,3));
        cardList.add(new GoldCard(79, Symbol.INSECT, Symbol.EMPTY, Symbol.EMPTY, Symbol.HIDDEN, Symbol.FEATHER, 3, CardType.GOLD,
                Symbol.EMPTY, 0,0,0,3));
